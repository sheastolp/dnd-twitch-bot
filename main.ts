  ...
  if (messageType === "notification") {
    ...
    if (chatMessage === "!logs") {
      ...
      const help = category === "dice"
        ...
        : category === "custom"
        ? "🛠️ Custom commands & triggers: !dndbot add <name> <response> | !dndbot edit <name> <response> | !dndbot remove <name> | !dndbot cooldown <name> <seconds> | !dndbot list | !trigger add <keyword> <response> | !trigger remove <keyword> | !trigger cooldown <keyword> <seconds> | !trigger list — add/edit/remove/cooldown are mod-only, list is open to everyone. Response placeholders: {user} {target} {count} {args} {random:a|b|c} {randnum:MIN-MAX} (e.g. {randnum:1-100}) {d4}/{d6}/{d8}/{d10}/{d12}/{d20}/{d100} {channel} {time} {date}"
